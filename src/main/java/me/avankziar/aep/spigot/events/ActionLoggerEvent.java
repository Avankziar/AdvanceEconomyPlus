...
public class ActionLoggerEvent extends Event
{
	...
	private ActionLoggerEvent.Type type;
	 ...
	 * @see ActionLogger
	 */
	public ActionLoggerEvent(LocalDateTime dateTime, String fromUUIDOrNumber, String toUUIDOrNumber,
			String fromName, String toName, String ordererUUID, double amount, ActionLoggerEvent.Type type, String comment)
	{
