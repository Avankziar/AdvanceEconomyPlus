...
public interface TableII
{
	...
	default boolean existII(AdvancedEconomyPlus plugin, String whereColumn, Object... object) 
	{
	...
	default boolean deleteDataII(AdvancedEconomyPlus plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
		try 
	...
	default int lastIDII(AdvancedEconomyPlus plugin)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default int countWhereIDII(AdvancedEconomyPlus plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<BankAccount> getListII(AdvancedEconomyPlus plugin, String orderByColumn,
	...
	default ArrayList<BankAccount> getTopII(AdvancedEconomyPlus plugin, String orderByColumn, int start, int end)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<BankAccount> getAllListAtII(AdvancedEconomyPlus plugin, String orderByColumn,
