...
public class ARGMoneyAction_FilterLog_Comment extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_FilterLog_Comment(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogComment(plugin, Methode.LOG, player, playername, searchword, page, cmdstring);
		return;
	}
}