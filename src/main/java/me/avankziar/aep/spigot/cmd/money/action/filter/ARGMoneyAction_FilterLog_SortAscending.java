...
public class ARGMoneyAction_FilterLog_SortAscending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_FilterLog_SortAscending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogSort(plugin, Methode.LOG, player, playername, false, page, cmdstring);
		return;
	}
}