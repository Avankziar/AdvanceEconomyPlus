...
public class ARGMoneyTrend_Grafic_FilterLog_FirstStandAscending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyTrend_Grafic_FilterLog_FirstStandAscending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.trendLogStand(plugin, Methode.GRAFIC, player, playername, false, true, page, cmdstring);
		return;
	}
}