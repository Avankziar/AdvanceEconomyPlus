...
public class ARGMoneyTrend_Diagram_FilterLog_FirstStandDescending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyTrend_Diagram_FilterLog_FirstStandDescending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.trendLogStand(plugin, Methode.DIAGRAM, player, playername, true, true, page, cmdstring);
		return;
	}
}