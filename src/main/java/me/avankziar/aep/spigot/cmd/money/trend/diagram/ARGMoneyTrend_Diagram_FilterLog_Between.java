...
public class ARGMoneyTrend_Diagram_FilterLog_Between extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyTrend_Diagram_FilterLog_Between(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.trendLogBetween(plugin, Methode.DIAGRAM, player, playername, min, max, page, cmdstring);
		return;
	}
}