...
public class ARGMoneyAction_Grafic_FilterLog_LessThan extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_Grafic_FilterLog_LessThan(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogLessThan(plugin, Methode.GRAFIC, player, playername, value, page, cmdstring);
		return;
	}
}