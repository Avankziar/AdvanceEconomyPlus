...
public class ARGMoneyAction_FilterLog_To extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_FilterLog_To(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogTo(plugin, Methode.LOG, player, playername, searchword, page, cmdstring);
		return;
	}
}