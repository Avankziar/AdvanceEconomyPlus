...
public class ARGMoneyAction_FilterLog_From extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_FilterLog_From(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogFrom(plugin, Methode.LOG, player, playername, searchword, page, cmdstring);
		return;
	}
}