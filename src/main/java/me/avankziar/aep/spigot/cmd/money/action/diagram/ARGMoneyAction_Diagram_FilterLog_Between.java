...
public class ARGMoneyAction_Diagram_FilterLog_Between extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_Diagram_FilterLog_Between(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogBetween(plugin, Methode.DIAGRAM, player, playername, min, max, page, cmdstring);
		return;
	}
}