...
public class ARGMoneyTrend_Grafic_FilterLog_LastStandDescending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyTrend_Grafic_FilterLog_LastStandDescending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.trendLogStand(plugin, Methode.GRAFIC, player, playername, true, false, page, cmdstring);
		return;
	}
}