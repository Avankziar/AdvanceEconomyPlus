...
public class ARGMoneyAction_Grafic_FilterLog_SortDescending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_Grafic_FilterLog_SortDescending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogSort(plugin, Methode.GRAFIC, player, playername, true, page, cmdstring);
		return;
	}
}