...
public class ARGMoneyTrend_Diagram_FilterLog_SortDescending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyTrend_Diagram_FilterLog_SortDescending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.trendLogSort(plugin, Methode.DIAGRAM, player, playername, true, page, cmdstring);
		return;
	}
}