...
public class ARGMoneyAction_FilterLog_CommentDescending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_FilterLog_CommentDescending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogCommentOther(plugin, Methode.LOG, player, playername, searchword, true, page, cmdstring);
		return;
	}
}