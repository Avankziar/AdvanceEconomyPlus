...
public class ARGMoneyTrend_Diagram_Log extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyTrend_Diagram_Log(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		if(args.length >= 5)
		{
			if(!player.hasPermission(Utility.PERM_CMD_MONEY_TRENDDIAGRAM_OTHER)
		...
		LogMethodeHandler.trendLog(plugin, Methode.DIAGRAM, player, playername, page, cmdstring);
		return;
	}
}