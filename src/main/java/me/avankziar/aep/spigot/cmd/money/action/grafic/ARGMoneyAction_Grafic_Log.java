...
public class ARGMoneyAction_Grafic_Log extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_Grafic_Log(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args) throws IOException
	{
		...
		LogMethodeHandler.actionLog(plugin, Methode.GRAFIC, player, playername, page, cmdstring);
		return;
	}
}