...
public class ARGMoneyAction_Grafic_FilterLog_CommentAscending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_Grafic_FilterLog_CommentAscending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogCommentOther(plugin, Methode.GRAFIC, player, playername, searchword, false, page, cmdstring);
		return;
	}
}