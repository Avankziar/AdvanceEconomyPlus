...
public class ARGMoneyTrend_Diagram_FilterLog_StandDescending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyTrend_Diagram_FilterLog_StandDescending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.trendLogStand(plugin, Methode.DIAGRAM, player, playername, true, page, cmdstring);
		return;
	}
}