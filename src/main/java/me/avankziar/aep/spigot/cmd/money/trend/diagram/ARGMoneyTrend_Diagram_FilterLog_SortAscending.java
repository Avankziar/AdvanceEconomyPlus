...
public class ARGMoneyTrend_Diagram_FilterLog_SortAscending extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyTrend_Diagram_FilterLog_SortAscending(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.trendLogSort(plugin, Methode.DIAGRAM, player, playername, false, page, cmdstring);
		return;
	}
}