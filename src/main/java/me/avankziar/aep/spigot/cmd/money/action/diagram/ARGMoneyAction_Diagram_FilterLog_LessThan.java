...
public class ARGMoneyAction_Diagram_FilterLog_LessThan extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_Diagram_FilterLog_LessThan(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogLessThan(plugin, Methode.DIAGRAM, player, playername, value, page, cmdstring);
		return;
	}
}