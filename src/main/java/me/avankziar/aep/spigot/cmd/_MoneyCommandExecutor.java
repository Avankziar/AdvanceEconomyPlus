...
public class _MoneyCommandExecutor implements CommandExecutor
{
	private AdvancedEconomyPlus plugin;
	private static CommandConstructor cc;
	
	public _MoneyCommandExecutor(AdvancedEconomyPlus plugin, CommandConstructor cc)
	{
		this.plugin = plugin;
		_MoneyCommandExecutor.cc = cc;
	}
