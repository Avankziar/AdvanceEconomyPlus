...
public class ARGMoneyAction_Diagram_FilterLog_GreaterThan extends ArgumentModule
{
	private AdvancedEconomyPlus plugin;
	private ArgumentConstructor ac;
	
	public ARGMoneyAction_Diagram_FilterLog_GreaterThan(AdvancedEconomyPlus plugin, ArgumentConstructor argumentConstructor)
	{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		LogMethodeHandler.actionLogGreaterThan(plugin, Methode.DIAGRAM, player, playername, value, page, cmdstring);
		return;
	}
}