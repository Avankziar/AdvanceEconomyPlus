...
public interface TableII
{
	...
	default boolean existII(AdvanceEconomy plugin, String whereColumn, Object... object) 
	{
	...
	default boolean createII(AdvanceEconomy plugin, Object object) 
	{
	...
	default boolean updateDataII(AdvanceEconomy plugin, Object object, String whereColumn, Object... whereObject) 
	{
		if(!(object instanceof BankAccount))
		{
			return false;
	...
	default Object getDataII(AdvanceEconomy plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default boolean deleteDataII(AdvanceEconomy plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
		try 
	...
	default int lastIDII(AdvanceEconomy plugin)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default int countWhereIDII(AdvanceEconomy plugin, String whereColumn, Object... whereObject)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
	...
	default ArrayList<BankAccount> getListII(AdvanceEconomy plugin, String orderByColumn,
	...
	default ArrayList<BankAccount> getTopII(AdvanceEconomy plugin, String orderByColumn, int start, int end)
	{
		PreparedStatement preparedStatement = null;
		ResultSet result = null;
		Connection conn = plugin.getMysqlSetup().getConnection();
