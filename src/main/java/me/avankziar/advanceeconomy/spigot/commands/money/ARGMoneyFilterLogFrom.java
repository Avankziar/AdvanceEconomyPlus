...
public class ARGMoneyFilterLogFrom extends CommandModule
{
	private AdvanceEconomy plugin;
	
	public ARGMoneyFilterLogFrom(AdvanceEconomy plugin)
	{
		super(StringValues.ARG_MONEY_FILTERLOGFROM, StringValues.PERM_CMD_MONEY_FILTERLOGFROM,
				AdvanceEconomy.moneyarguments,2,4,StringValues.ARG_MONEY_FILTERLOGFROM_ALIAS,
				StringValues.MONEY_SUGGEST_FILTERLOGFROM);
		this.plugin = plugin;
	}
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		String cmdstring = "/money filterlogfrom "+searchword;
