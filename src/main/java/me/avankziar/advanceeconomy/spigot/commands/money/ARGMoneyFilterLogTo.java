...
public class ARGMoneyFilterLogTo extends CommandModule
{
	private AdvanceEconomy plugin;
	
	public ARGMoneyFilterLogTo(AdvanceEconomy plugin)
	{
		super(StringValues.ARG_MONEY_FILTERLOGTO, StringValues.PERM_CMD_MONEY_FILTERLOGTO,
				AdvanceEconomy.moneyarguments,2,4,StringValues.ARG_MONEY_FILTERLOGTO_ALIAS,
				StringValues.MONEY_SUGGEST_FILTERLOGTO);
		this.plugin = plugin;
	}
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		String cmdstring = "/money filterlogto "+searchword;
