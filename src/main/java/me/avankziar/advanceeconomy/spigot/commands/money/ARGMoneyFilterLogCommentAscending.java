...
public class ARGMoneyFilterLogCommentAscending extends CommandModule
{
	private AdvanceEconomy plugin;
	
	public ARGMoneyFilterLogCommentAscending(AdvanceEconomy plugin)
	{
		super(StringValues.ARG_MONEY_FILTERLOGCOMMENTASCENDING, StringValues.PERM_CMD_MONEY_FILTERLOGCOMMENTASCENDING,
				AdvanceEconomy.moneyarguments,2,4,StringValues.ARG_MONEY_FILTERLOGCOMMENTASCENDING_ALIAS,
				StringValues.MONEY_SUGGEST_FILTERLOGCOMMENTASCENDING);
		this.plugin = plugin;
	}
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		String cmdstring = "/money filterlogcommentascending "+searchword;
