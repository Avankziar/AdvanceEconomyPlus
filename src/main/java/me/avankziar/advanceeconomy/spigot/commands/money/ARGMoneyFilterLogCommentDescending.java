...
public class ARGMoneyFilterLogCommentDescending extends CommandModule
{
	private AdvanceEconomy plugin;
	
	public ARGMoneyFilterLogCommentDescending(AdvanceEconomy plugin)
	{
		super(StringValues.ARG_MONEY_FILTERLOGCOMMENTDESCENDING, StringValues.PERM_CMD_MONEY_FILTERLOGCOMMENTDESCENDING,
				AdvanceEconomy.moneyarguments,2,4,StringValues.ARG_MONEY_FILTERLOGCOMMENTDESCENDING_ALIAS,
				StringValues.MONEY_SUGGEST_FILTERLOGCOMMENTDESCENDING);
		this.plugin = plugin;
	}
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		String cmdstring = "/money filterlogcommentdescending "+searchword;
