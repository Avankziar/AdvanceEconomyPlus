...
public class ARGMoneyFilterLogSortAscending extends CommandModule
{
	private AdvanceEconomy plugin;
	
	public ARGMoneyFilterLogSortAscending(AdvanceEconomy plugin)
	{
		super(StringValues.ARG_MONEY_FILTERLOGSORTASCENDING, StringValues.PERM_CMD_MONEY_FILTERLOGSORTASCENDING,
				AdvanceEconomy.moneyarguments,1,3,StringValues.ARG_MONEY_FILTERLOGSORTASCENDING_ALIAS,
				StringValues.MONEY_SUGGEST_FILTERLOGSORTASCENDING);
		this.plugin = plugin;
	}
