...
import me.avankziar.aep.bungee.api.LoggerApi;
...
import me.avankziar.ifh.bungee.economy.subinterfaces.CurrencyHandling.Exchange;
...
public class TransactionHandler
{
	...
	private void saveAccount(Account... account)
	{
		for(Account a : account)
		{
			...
			plugin.getMysqlHandler().updateData(MysqlType.ACCOUNT_BUNGEE, new AccountBungee(a), "`id` = ?", a.getID());
		}
	}
