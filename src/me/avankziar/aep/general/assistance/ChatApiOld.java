...
{	
	...
	public static TextComponent click(TextComponent msg, ClickEvent.Action caction, String cmd)
	{
		msg.setClickEvent( new ClickEvent(caction, cmd));
		return msg;
	}
	
	public static TextComponent click(String text, ClickEvent.Action caction, String cmd)
	{
	...
	public static TextComponent hover(TextComponent msg, HoverEvent.Action haction, String hover)
	{
		String sepnewline = "~!~";
	...
	public static TextComponent hover(String text, HoverEvent.Action haction, String hover)
	{
		String sepnewline = "~!~";
		TextComponent msg = null;
		ArrayList<BaseComponent> components = new ArrayList<>();
	...
	public static TextComponent clickHover(String text, ClickEvent.Action caction, String cmd,
			...
			if(word.contains(sepb))
			{
				...
				if(function.length == 2)
				{
					if(function[1].contains(idhover))
					{
						...
						ChatApiOld.hover(newtc,HoverEvent.Action.valueOf(at[1]), at[2].replace(sepspace, " "));
					}
					if(function[1].contains(idclick))
					{
						String[] at = function[1].split(sepw);
						ChatApiOld.click(newtc,ClickEvent.Action.valueOf(at[1]), at[2].replace(sepspace, " "));
					}
				}
