...
public class AccountBungee extends me.avankziar.ifh.bungee.economy.account.Account implements MysqlHandable
{
	public AccountBungee()
	{
		super("", AccountType.WALLET, AccountCategory.MAIN, null, null, 0, false);
	}
	
	public AccountBungee(String accountName, AccountType type, AccountCategory category, EconomyCurrency currency,
	...
	public AccountBungee(int id, String accountName, AccountType type, AccountCategory category, EconomyCurrency currency,
			EconomyEntity owner, double balance, boolean predefinedAccount)
	{
		super(id, accountName, type, category, currency, owner, balance, predefinedAccount);
	}
	
	public AccountBungee(me.avankziar.ifh.bungee.economy.account.Account acc)
	{
	...
	public static ArrayList<AccountBungee> convert(ArrayList<Object> arrayList)
	{
		ArrayList<AccountBungee> l = new ArrayList<>();
		for(Object o : arrayList)
		{
			if(o instanceof AccountBungee)
			{
				l.add((AccountBungee) o);
			}
		}
		return l;
	}
