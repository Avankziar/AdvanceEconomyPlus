...
public class AccountVelo extends me.avankziar.ifh.velocity.economy.account.Account implements MysqlHandable
{
	public AccountVelo()
	{
	...
	public AccountVelo(String accountName, AccountType type, AccountCategory category, EconomyCurrency currency,
	...
	public AccountVelo(int id, String accountName, AccountType type, AccountCategory category, EconomyCurrency currency,
			EconomyEntity owner, double balance, boolean predefinedAccount)
	{
		super(id, accountName, type, category, currency, owner, balance, predefinedAccount);
	}
	
	public AccountVelo(me.avankziar.ifh.velocity.economy.account.Account acc)
	{
