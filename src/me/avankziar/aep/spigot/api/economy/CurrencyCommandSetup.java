...
import me.avankziar.aep.spigot.cmd.AepCommandExecutor;
import me.avankziar.aep.spigot.cmd.LoanCommandExecutor;
import me.avankziar.aep.spigot.cmd.StandingOrderCommandExecutor;
import me.avankziar.aep.spigot.cmd.TABCompletion;
import me.avankziar.aep.spigot.cmd.cet.account.AccountClose;
import me.avankziar.aep.spigot.cmd.cet.account.AccountManage;
import me.avankziar.aep.spigot.cmd.cet.account.AccountOpen;
import me.avankziar.aep.spigot.cmd.cet.account.AccountOverdue;
import me.avankziar.aep.spigot.cmd.cet.account.AccountPermissionInfo;
import me.avankziar.aep.spigot.cmd.cet.account.AccountSetDefault;
import me.avankziar.aep.spigot.cmd.cet.account.AccountSetName;
import me.avankziar.aep.spigot.cmd.cet.account.AccountSetOwner;
import me.avankziar.aep.spigot.cmd.cet.account.AccountSetQuickPay;
import me.avankziar.aep.spigot.cmd.cet.account.Accounts;
import me.avankziar.aep.spigot.cmd.cet.base.ActionLog;
import me.avankziar.aep.spigot.cmd.cet.base.BankNotification;
...
import me.avankziar.aep.spigot.cmd.cet.base.TrendLog;
import me.avankziar.aep.spigot.cmd.cet.base.WalletNotification;
import me.avankziar.aep.spigot.cmd.cet.loggersettings.LoggerSettings;
import me.avankziar.aep.spigot.cmd.cet.loggersettings.LoggerSettingsGui;
import me.avankziar.aep.spigot.cmd.cet.loggersettings.LoggerSettingsOther;
import me.avankziar.aep.spigot.cmd.cet.loggersettings.LoggerSettingsText;
import me.avankziar.aep.spigot.cmd.cst.Balance;
import me.avankziar.aep.spigot.cmd.cst.transaction.Give;
import me.avankziar.aep.spigot.cmd.cst.transaction.GiveConsole;
import me.avankziar.aep.spigot.cmd.cst.transaction.Pay;
import me.avankziar.aep.spigot.cmd.cst.transaction.PayThroughGui;
import me.avankziar.aep.spigot.cmd.cst.transaction.Set;
import me.avankziar.aep.spigot.cmd.cst.transaction.SetConsole;
import me.avankziar.aep.spigot.cmd.cst.transaction.Take;
import me.avankziar.aep.spigot.cmd.cst.transaction.TakeConsole;
import me.avankziar.aep.spigot.cmd.cst.transaction.Transfer;
import me.avankziar.aep.spigot.cmd.loan.LoanAccept;
import me.avankziar.aep.spigot.cmd.loan.LoanAmount;
import me.avankziar.aep.spigot.cmd.loan.LoanCancel;
import me.avankziar.aep.spigot.cmd.loan.LoanCreate;
import me.avankziar.aep.spigot.cmd.loan.LoanForgive;
import me.avankziar.aep.spigot.cmd.loan.LoanInfo;
import me.avankziar.aep.spigot.cmd.loan.LoanInherit;
import me.avankziar.aep.spigot.cmd.loan.LoanList;
import me.avankziar.aep.spigot.cmd.loan.LoanPause;
import me.avankziar.aep.spigot.cmd.loan.LoanPayback;
import me.avankziar.aep.spigot.cmd.loan.LoanReject;
import me.avankziar.aep.spigot.cmd.loan.LoanRepay;
import me.avankziar.aep.spigot.cmd.loan.LoanSend;
import me.avankziar.aep.spigot.cmd.loan.LoanTime;
import me.avankziar.aep.spigot.cmd.loan.LoanTransfer;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderAmount;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderCancel;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderCreate;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderDelete;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderEndTime;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderInfo;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderList;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderPause;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderRepeatingtime;
import me.avankziar.aep.spigot.cmd.standingorder.StandingOrderStarttime;
...
public class CurrencyCommandSetup
{
	...
	public CurrencyCommandSetup(AEP plugin)
	{
		this.plugin = plugin;
		setupPlayers();
		setupAccount();
	...
	{		
		...
		if(plugin.getYamlHandler().getCommands().get("Commands.SINGLE") != null)
		{
			CommandStructurType cst = CommandStructurType.SINGLE;
			for(String s : plugin.getYamlHandler().getCommands().getStringList("Commands.SINGLE"))
			{
				String[] sp = s.split(";");
				if(sp.length != 2)
				{
				...
				if(cmd.getName() == null)
				{
					AEP.logger.warning("Commandpath "+cmdpath+" dont exist in commands.yml! Command are not registered!");
					continue;
				}
		...
		if(plugin.getYamlHandler().getCommands().get("Commands.NESTED") != null)
		{
			...
			for(String s : plugin.getYamlHandler().getCommands().getStringList("Commands.NESTED"))
			{
				String[] sp = s.split(";");
				if(sp.length != 2)
				{
		...
		if(aep.getName() == null)
		{
			AEP.logger.warning("Commandpath "+aep.getPath()+" dont exist in commands.yml! Command are not registered!");
			return;
		}
	...
	private void addLoanArgumentConstructor()
	{
		...
		{
			AEP.logger.warning("Commandpath "+loan.getPath()+" dont exist in commands.yml! Command are not registered!");
			return;
		}
	...
	private void addStandingOrderArgumentConstructor()
	{
		...
		{
			AEP.logger.warning("Commandpath "+standingorder.getPath()+" dont exist in commands.yml! Command are not registered!");
			return;
		}
	...
	public void setupSingle(EconomyCurrency ec, YamlDocument y)
	{
	...
	public void setupNested(EconomyCurrency ec, YamlDocument y)
	{
	...
	private void setupPlayers()
	{
		ArrayList<AEPUser> cu = ConvertHandler.convertListI(
				plugin.getMysqlHandler().getList(MysqlType.PLAYERDATA,
						"`id`", 0,
						plugin.getMysqlHandler().lastID(MysqlType.PLAYERDATA),
						"?", 1));
	...
	{
		ArrayList<Account> a = ConvertHandler.convertListII(plugin.getMysqlHandler().getList(MysqlType.ACCOUNT_SPIGOT,
				"`id`", 0,
				plugin.getMysqlHandler().lastID(MysqlType.ACCOUNT_SPIGOT),
				"?", 1));
