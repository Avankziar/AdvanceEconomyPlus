...
import me.avankziar.ifh.spigot.economy.subinterfaces.CurrencyHandling.Exchange;
...
public class TransactionHandler
{
	...
	private boolean existAccount(Account account)
	{
		...
		return plugin.getMysqlHandler().exist(MysqlType.ACCOUNT_SPIGOT, "`id` = ?", account.getID());
	}
	...
	private void saveAccount(Account... account)
	{
		for(Account a : account)
		{
			...
			plugin.getMysqlHandler().updateData(MysqlType.ACCOUNT_SPIGOT, a, "`id` = ?", a.getID());
		}
	}
