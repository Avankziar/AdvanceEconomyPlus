...
public class StandingOrderDelete extends ArgumentModule
{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		plugin.getMysqlHandler().deleteData(MysqlType.STANDINGORDER, "`id` = ?", id);
		player.sendMessage(ChatApiOld.tl(plugin.getYamlHandler().getLang().getString("Cmd.StandingOrder.Delete.IsDeleted")));
		return;
	}
}